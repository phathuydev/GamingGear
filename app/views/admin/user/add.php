  ...
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Add User</h4>
        ...
        HtmlHelper::input('<div class="form-group">' . '<label>Username</label>' . '<em class="text-danger"> * </em>', '<p class="text-danger m-2" id="error_user_name"></p>' . '</div>', 'text', 'user_name', '', 'form-control', 'user_name', 'Username', '');
        ...
        HtmlHelper::input('<div class="form-group">' . '<label>Image</label>' . '<em class="text-danger"> * </em>' . '<div class="custom-file form-control">', '<p class="text-danger" id="error_user_image"></p>' . '<label class="custom-file-label bg-transparent border text-muted d-flex align-items-center">Choose file</label>' . '</div>' . '</div>', 'file', 'user_image', 'image/png, image/jpeg, image/jpg', 'custom-file-input text-white', 'user_image', '', '');
