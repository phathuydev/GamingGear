    ...
    <div class="card-body">
      ...
      <form class="forms-sample" method="post" enctype='multipart/form-data' onsubmit="return validateProducts()">
        <div class="form-group">
          ...
          <input type="text" class="form-control text-white" name="product_name" placeholder="Name product" id="product_name">
        ...
        <div class="form-group">
          ...
          <div class="custom-file form-control">
            ...
            <input type="file" class="form-control custom-file-input text-white" name="product_image" id="product_image" placeholder="Image" accept='image/png, image/jpeg, image/jpg'>
          </div>
          <p class="text-danger m-2" id="error_product_image"></p>
        </div>
        <div class="form-group">
          <label>Price ($)<em class="text-danger"> * </em></label>
          <input type="num" class="form-control text-white" name="product_price" placeholder="Price" id="product_price">
          <p class="text-danger m-2" id="error_product_price"></p>
        </div>
        <div class="form-group">
          <label for="">Price reduce ($)</label>
          <input type="num" class="form-control text-white" name="product_price_reduce" id="product_price_reduce" placeholder="Price reduce">
        </div>
        <p class="text-danger m-2" id="error_product_price_reduce"></p>
        <div class="form-group">
          <label for="">Quantity<em class="text-danger"> * </em></label>
          <input type="text" class="form-control text-white" name="product_quantity" placeholder="Quantity" id="product_quantity">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control text-white" name="product_describe" placeholder="Desctibe" id="product_describe">
