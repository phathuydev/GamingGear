    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="product">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="<?php echo _MANAGE_DEFAULT ?>/product/list/8/1">List</a></li>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="category">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="<?php echo _MANAGE_DEFAULT ?>/category/list/8/1">List</a></li>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="banner">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a class="nav-link" href="<?php echo _MANAGE_DEFAULT ?>/banner/list/1/8/1">List</a></li>
            <li class="nav-item"><a class="nav-link" href="<?php echo _MANAGE_DEFAULT ?>/banner/banner_home_add">Add Home</a></li>
          </ul>
        </div>
      </li>
    </ul>
