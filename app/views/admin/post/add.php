      ...
      <form class="forms-sample" method="post" enctype='multipart/form-data' onsubmit="return validateAddPost()">
        <div class="form-group">
          ...
          <div class="custom-file form-control text-white">
            ...
            <input type="file" class="form-control custom-file-input text-white" name="post_image_section" id="post_image_section" placeholder="Image" accept='image/png, image/jpeg, image/jpg'>
          </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control text-white" name="post_title_content" id="post_title_content" placeholder="Content Title">
        ...
        <div class=" form-group">
          ...
          <div class="custom-file form-control text-white">
            <label class="custom-file-label bg-transparent border text-muted d-flex align-items-center">Choose file</label>
            <input type="file" class="form-control custom-file-input text-white" name="post_image_content" id="post_image_content" placeholder="Image" accept='image/png, image/jpeg, image/jpg'>
          </div>
          <p class="text-danger m-2" id="error_post_image_content"></p>
        </div>
        <div class="form-group">
          <label for="">Post Content<em class="text-danger"> * </em></label>
          <textarea name="post_content_content" id="post_content_content" class="form-control text-white" cols="30" rows="10" placeholder="Post Content"></textarea>
