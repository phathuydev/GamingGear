            ...
            <?php foreach ($listOrder as $key => $item) : ?>
              <tr class="border-bottom">
                ...
                <td class="d-flex align-items-center">
                  <a class="badge badge-primary mr-2" href="<?php echo _MANAGE_DEFAULT ?>/order/order_detail/<?= $item['order_id']; ?>">See detail</a>
                  <a class="badge badge-success mr-2" href="<?php echo _MANAGE_DEFAULT ?>/order/order_edit/<?= $item['order_id']; ?>/<?= $item['order_status']; ?>">Update status</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
