              ...
              <tr class="border-bottom">
                ...
                <td class="d-flex align-items-center pt-4">
                  <form method="post" class="m-0">
                    ...
                    <button type="submit" name="deleteCommentProduct" class="badge badge-danger border-0" onclick="return confirm('Delete Comment <?= $item['comment_content'] ?>');">Delete Comment</button>
                  </form>
                </td>
              </tr>
            <?php endforeach ?>
