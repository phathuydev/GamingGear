          ...
          <div class="row gx-5">
            ...
            <main class="col-lg-6 mt-4">
              <div class="ps-lg-3">
                ...
                <div class="row mb-4">
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="input-group mb-3 mt-3" style="width: 170px;">
                      ...
                      <input id="form1" min="0" max="<?= $getProductDetail['product_quantity'] ?>" name="product_quantity" value="1" type="number" class="form-control text-center border border-secondary text-black" />
                ...
                <button type="submit" class="btn shadow-0" name="add_to_cart" style="background-color: #ec6090; color: #fff;" <?= !empty($getProductDetail['product_quantity']) <= 0 ? 'disabled' : '' ?>><i class="me-1 fa fa-shopping-basket"></i> Add To Cart</button>
              </div>
            </main>
          </div>
        </div>
                  ...
                  <div class="col mb-5">
                    <?php foreach ($getComment as $comment) : ?>
                      ...
                      <div class="d-flex flex-start">
                        <img src="<?= !empty($comment['user_image_path']) ? _WEB_ROOT . '/' . ($comment['user_image'] ? $comment['user_image_path'] . '/' . $comment['user_image'] : 'public/assets/admin/uploaded_img/default_img.jpg') : ($comment['user_image'] ? $comment['user_image'] : _WEB_ROOT . '/' . $comment['user_image_path'] . 'public/assets/admin/uploaded_img/default_img.jpg'); ?>" alt="" class="me-3 mt-2" style="width: 45px !important; height: 45px !important; border-radius: 30px;">
                        <div class="flex-grow-1 flex-shrink-1 mb-3">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <?php if ($comment['user_id'] == $client_login) : ?>
                              <!-- Sửa và xóa -->
                              <button class="ml-3 reply-btn border-0 text-white" data-toggle="modal" data-target="#exampleModalCenter<?= $comment['comment_id']; ?>" style="font-size: 20px; background-color:#1f2122;" title="Edit"><i class="fa fa-edit fa-xs"></i></button>
                              <form action="" method="post">
                            ...
                            <?php else : ?>
                              ...
                              <?php if (isset($client_login)) : ?>
                                <button class="ml-3 reply-btn border-0 text-white" data-toggle="modal" data-target="#exampleModalCenter<?= $comment['comment_id']; ?>" style="font-size: 20px; background-color:#1f2122;" title="Repply"><i class="fa fa-reply fa-xs"></i></button>
                              <?php endif ?>
                              <!-- Đóng hành động comment cha -->
                              <!-- Modal -->
                              <div class="modal fade" id="exampleModalCenter<?= $comment['comment_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    ...
                                    <form method="post" class="w-100 slidebar">
                                      <div class="modal-body pt-0 pb-0">
                                        <div class="d-flex align-items-center justify-content-start mb-2 mt-2">
                                          ...
                                          <input type="text" name="comment_content" class="rounded-5 p-2 w-100 small" placeholder="Enter a reply comment" required>
                                          <input type="hidden" name="user_id" value="<?= $client_login ?>">
                                          <input type="hidden" name="product_id" value="<?= $getProductDetail['product_id'] ?>">
                                      ...
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary small" data-dismiss="modal">Close
                                        </button>
                                        <button type="submit" name="reply_comment_father" class="btn btn-primary small">Send
                                        </button>
                                      </div>
                                    </form>
                                  </div>
                                  ...
                                  <form method="post" class="w-100 slidebar">
                                    <div class="modal-body pt-0 pb-0">
                                      <div class="d-flex align-items-center justify-content-start mb-2 mt-2">
                                        ...
                                        <input type="text" name="comment_content_new" class="rounded-5 ps-2 w-100 small" value="<?= $comment['comment_content'] ?>" required>
                                      </div>
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary small" data-dismiss="modal">Close
                                      </button>
                                      <button type="submit" name="edit_comment_father" class="btn btn-primary small">Apply
                                      </button>
                                    </div>
                                  </form>
                                </div>
                          ...
                          <?php foreach ($replies as $reply) : ?>
                                ...
                                <div>
                                  ...
                                  <div class="d-flex align-items-center">
                                    ...
                                    <?php if ($reply['user_id'] == $client_login) : ?>
                                      <button class="ml-3 reply-btn border-0 text-white" data-toggle="modal" data-target="#exampleModalCenter<?= $reply['comment_id']; ?>" style="font-size: 20px; background-color:#1f2122;" title="Edit"><i class="fa fa-edit fa-xs"></i></button>
                                      <form action="" method="post">
                                        <input type="hidden" name="user_delete" value="<?= Session::data('client_login'); ?>">
                                    ...
                                    <?php else : ?>
                                      <?php if (isset($client_login)) : ?>
                                        <button class="ml-3 reply-btn border-0 text-white" data-toggle="modal" data-target="#exampleModalCenter<?= $reply['comment_id']; ?>" class="ml-3" style="font-size: 20px; background-color:#1f2122;" title="Repply"><i class="fa fa-reply fa-xs"></i></button>
                                      <?php endif ?>
                                    <?php endif ?>
                                  </div>
                                </div>
                            ...
                            <?php if ($reply['user_id'] != $client_login) : ?>
                              <!-- Modal -->
                              <div class="modal fade" id="exampleModalCenter<?= $reply['comment_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form method="post" class="w-100 slidebar">
                                      <div class="modal-body pt-0 pb-0">
                                        <div class="d-flex align-items-center justify-content-start mb-2 mt-2">
                                          <img class="rounded-circle shadow-1-strong me-3" src="<?= !empty($getUserClient['user_image_path']) ? _WEB_ROOT . '/' . ($getUserClient['user_image'] ? $getUserClient['user_image_path'] . '/' . $getUserClient['user_image'] : 'public/assets/admin/uploaded_img/default_img.jpg') : ($getUserClient['user_image'] ? $getUserClient['user_image'] : _WEB_ROOT . '/' . $getUserClient['user_image_path'] . 'public/assets/admin/uploaded_img/default_img.jpg'); ?>" alt="avatar" style="width: 45px !important; border-radius: 30px;" />
                                          <input type="text" name="comment_content" class="rounded-5 p-2 w-100 small" value="<?= ($reply['user_name'] == null) ? '@' . $reply['user_email'] . ' ' : '@' . $reply['user_name'] . ' ' ?>" required>
                                          <input type="hidden" name="user_id" value="<?= $client_login ?>">
                                          <input type="hidden" name="product_id" value="<?= $getProductDetail['product_id'] ?>">
                                          <input type="hidden" name="parent_id" value="<?= $comment['comment_id'] ?>">
                                        </div>
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <button type="submit" name="reply_comment_son" class="btn btn-primary small">Send
                                        </button>
                                      </div>
                                    </form>
                                  </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form method="post" class="w-100 slidebar">
                                      <div class="modal-body pt-0 pb-0">
                                        <div class="d-flex align-items-center justify-content-start mb-2 mt-2">
                                          <img class="rounded-circle shadow-1-strong me-3" src="<?= !empty($reply['user_image_path']) ? _WEB_ROOT . '/' . ($reply['user_image'] ? $reply['user_image_path'] . '/' . $reply['user_image'] : 'public/assets/admin/uploaded_img/default_img.jpg') : ($reply['user_image'] ? $reply['user_image'] : _WEB_ROOT . '/' . $reply['user_image_path'] . 'public/assets/admin/uploaded_img/default_img.jpg'); ?>" alt="avatar" style="width: 45px !important; border-radius: 30px;" />
                                          <input type="hidden" name="comment_id" class="rounded-5 p-2 w-100 small" value="<?= $reply['comment_id'] ?>">
                                          <input type="text" name="comment_content_new" class="rounded-5 p-2 w-100 small" value="<?= $reply['comment_content'] ?>" required>
                                        </div>
                                      </div>
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary small" data-dismiss="modal">Close
                                        </button>
                                        <button type="submit" name="edit_comment_son" class="btn btn-primary small">Apply
                                        </button>
                                      </div>
                                    </form>
                                  </div>
                                  ...
                                  <form method="post" class="w-100 slidebar">
                                    <div class="modal-body pt-0 pb-0">
                                      <div class="d-flex align-items-center justify-content-start mb-2 mt-2">
                                        <img class="rounded-circle shadow-1-strong me-3" src="<?= !empty($getUserGoogle['user_image_path']) ? _WEB_ROOT . '/' . $getUserGoogle['user_image_path'] . ($getUserGoogle['user_image'] ? $getUserGoogle['user_image'] : 'public/assets/admin/uploaded_img/default_img.jpg') : ($getUserGoogle['user_image'] ? $getUserGoogle['user_image'] : _WEB_ROOT . '/' . $getUserGoogle['user_image_path'] . 'public/assets/admin/uploaded_img/default_img.jpg'); ?>" alt="avatar" style="width: 45px !important; border-radius: 30px;" />
                                        <input type="hidden" name="comment_id" class="rounded-5 ps-2 w-100 small" value="<?= $comment['comment_id'] ?>">
                                        <input type="text" name="comment_content_new" class="rounded-5 p-2 w-100 small" value="<?= $comment['comment_content'] ?>" required>
                                      </div>
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary small" data-dismiss="modal">Close
        ...
        <div class="container">
          ...
          <div class="row d-flex justify-content-center">
            <div class="col-md-12 col-lg-10 col-xl-8">
              <div class="card-body p-0">
                <div class="mt-3 mb-5">
                  <h4 class="text-center h5 text-white"><a href="<?= _WEB_ROOT ?>/lgUser" class="text-danger">Sign in</a> to post a comment
                  </h4>
                </div>
                <p class="h6 text-white"><?= count($getComment) . ' Comment(s)' ?></p>
                <hr class="border border-white mb-5">
