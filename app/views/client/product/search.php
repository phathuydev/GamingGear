            ...
            <?php foreach ($getProductSearch as $item) : ?>
                <div class="bg-transparent featured-games header-text col-md-3 col-sm-12">
                    <div class="card-pd" style="height: 100%;">
                        <form method="POST">
                            <div class="imgBox">
                                <a href="<?php echo _PRODUCT_DEFAULT; ?>/product_detail/<?= $item['product_id'] . '/' . $item['category_id'] ?>/8/1"><img
                            ...
                            <div class="contentBox">
                                ...
                                <button type="submit" class="buy" style="font-size: 10px; padding: 5px 15px 5px 15px;"
                            ...
                            <input type="hidden" name="product_price_reduce"
