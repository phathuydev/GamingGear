          ...
          <div class="col-lg-4 ps-0">
            <div class="mb-4">
              <div class="card-body text-center bg-dark rounded-3">
                <img src="<?php echo _WEB_ROOT . '/' . $getUserClient['user_image_path'] . ($getUserClient['user_image'] ? $getUserClient['user_image'] : 'public/assets/admin/uploaded_img/default_img.jpg'); ?>" alt="avatar" class="rounded-circle img-fluid" style="width: 150px;">
              </div>
            </div>
