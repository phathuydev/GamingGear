<section class="rounded" style="background-color:#212529;">
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group list-group-flush rounded-3">
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                <i class="fa fa-user fa-lg text-danger" style="color: #333333;"></i>
                                <a href="profile" class="mb-0">Thông tin tài khoản</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                <i class="fa fa-shopping-basket fa-lg text-warning"></i>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form action="#" method="POST">
                                <h4 class="text-dark">Thông tin tài khoản</h4><br>
                                <div class="form-row pl-5">
                                    ...
                                    <div class="form-group col-8 d-flex align-items-center">
                                        ...
                                        <input type="date" class="form-control ml-5" id="birthday" name="birthday"
                                               required>
                                    </div>
                            </form>
                        </div>
