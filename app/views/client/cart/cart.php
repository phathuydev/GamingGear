<div class="row d-flex justify-content-center my-4 heading-section page-content">
  <div class="col-md-8">
    <div class="card most-popular mt-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="d-flex mb-4" style="max-width: 300px">
              <button class="btn px-3 me-2" style="background-color: #27292a; color: #fff;" onclick="this.parentNode.querySelector('input[type=number]').stepDown()">
              ...
              <button class="btn px-3 ms-2" style="background-color: #27292a; color: #fff;" onclick="this.parentNode.querySelector('input[type=number]').stepUp()">
  ...
  <div class="col-md-4">
    <div class="card mb-4 most-popular mt-0">
      <div class="card-header py-3">
    ...
    <div class="card mt-4 mb-lg-0 most-popular p-0">
      <div class="card-body">
