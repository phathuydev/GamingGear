                ...
                <div class="" style="border-radius: 1rem;">
                    <div class="row g-0 align-items-center">
                                ...
                                <form>
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form2Example27"
                                               style="color: #ec6090;">Password</label>
                                        <input type="password" id="form2Example27"
                                               class="form-control form-control-lg"/>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form2Example27" style="color: #ec6090;">Confirm
                                            Password</label>
                                        <input type="password" id="form2Example27"
                                               class="form-control form-control-lg"/>
                                    </div>
                                    ...
                                    <button class="btn btn-lg btn-block btn-primary mt-5"
                                            style="background-color: #dd4b39;" type="submit"><i
                                                class="fab fa-google me-2 mb-3"></i> Sign in with google
                                    </button>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <img src="<?= _WEB_ROOT; ?>/public/assets/client/images/banner_regis.jpg" alt="login form"
