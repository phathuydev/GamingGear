                    ...
                    <div class="" style="border-radius: 1rem;">
                        <div class="row g-0 align-items-center">
                            <div class="col-md-6 col-lg-6 d-none d-md-block">
                                <img src="/public/assets/client/images/banner_login.jpg" alt="login form"
                            ...
                            <div class="col-md-6 col-lg-6 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form>
                                        ...
                                        <a class="small text-muted" href="<?php echo _WEB_ROOT ?>/forgot">Forgot
                                            password?</a>
                                        <a href="<?php echo _WEB_ROOT ?>/register" style="color: #393f81;">Register
                                            here</a></p>
                                        ...
                                        <div class="card-body p-4 p-lg-5 text-black">
                                            ...
                                            <form>
                                                ...
                                                <div class="d-flex align-items-center mb-3 pb-1">
                                                    <span class="h1 fw-bold mb-0">
                                                        <img class="img-login"
                                                            src="/public/assets/client/images/icon-logo.png" alt="">
                                                    </span>
                                                </div>
                                                ...
                                                <a class="small text-muted" href="<?php echo _WEB_ROOT ?>/forgot">Forgot
                                                    password?</a>
                                                <a href="<?php echo _WEB_ROOT ?>/register"
