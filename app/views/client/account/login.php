                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                        <form>
                            ...
                            <a class="small text-muted" href="<?php echo _WEB_ROOT ?>/forgot">Forgot
                                password?</a>
                            <a href="<?php echo _WEB_ROOT ?>/register" style="color: #393f81;">Register here</a></p>
                            <button class="btn btn-lg btn-block btn-primary mt-5" style="background-color: #dd4b39;"
