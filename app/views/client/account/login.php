            ...
            <form method="post">
                <div class="d-flex align-items-center mb-3 pb-1">
                    <span class="h1 fw-bold mb-0">
                        <img class="img-login" src="<?php echo _WEB_ROOT ?>/public/assets/client/images/icon-logo.png"
                             alt="" style="width: 50px !important;">
                    </span>
                </div>
                <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px; color: #ec6090;">Sign into your account</h5>
                ...
                <a class="small text-white" href="<?php echo _WEB_ROOT ?>/client/account/auth/forgot">Forgot
                    password?</a>
                <a href="<?php echo _WEB_ROOT ?>/client/account/auth/register" class="h6" style="color: #ec6090;">Register
                    here</a></p>
