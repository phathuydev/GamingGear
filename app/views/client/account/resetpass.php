...
<body class="header-text" style="background-image: url('http://1.bp.blogspot.com/-RUGcTW3FR2U/Ur12Bi3G5QI/AAAAAAAABzk/WC0wQdRHhw4/s1600/B1.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center;">
                                    ...
                                    <div class="card-body p-0 shadow-5 text-center">
                                        <form method="post" class="card-body text-cente d-inline-block">
                                            ...
                                            <div class="form-outline mb-4">
                                                <input type="password" id="typeEmailX-2" name="password" class="form-control form-control-lg" placeholder="Password" />
                                            </div>
                                            <div class="form-outline mb-4">
                                                <input type="password" id="typeEmailX-2" name="cpassword" class="form-control form-control-lg" placeholder="Confirm Password" />
                                            </div>
                                            <button class="btn btn-lg btn-block mb-2" type="submit" style="background-color: #ec6090; color: #fff;">Reset</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
