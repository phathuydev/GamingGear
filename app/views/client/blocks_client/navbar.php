        ...
        <nav class="main-nav d-flex align-items-center pt-2">
          ...
          <div class="search-input position-relative">
            <form id="search" class="d-flex" action="" method="post">
              <input type="text" class="bg-white ps-3 pe-3" placeholder="Seach" id='searchText' name="searchKeyword">
              <input type="submit" name="searchProduct" class="bg-black border text-white position-absolute p-2 end-0" id="" value="Tìm kiếm">
            </form>
          </div>
          <!-- ***** Search End ***** -->
          <!-- ***** Menu Start ***** -->
