      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
          ...
          ?>
            <li data-target="#carouselExampleIndicators" data-slide-to="<?= $key; ?>" class="<?= $key == 0 ? 'active' : false; ?>"></li>
          <?php endforeach; ?>
        </ol>
        <div class="carousel-inner">
          ...
          ?>
            <div class="carousel-item <?= $key == 0 ? 'active' : false; ?>">
              <img class="d-block w-100" src="<?php echo _WEB_ROOT . '/' . $item['banner_home_path'] . $item['banner_home_image'] ?>" alt="<?= $descriptions[$key]; ?> slide">
            </div>
          <?php endforeach; ?>
        </div>
      ...
      <div class="container w-auto">
                ...
                <div class="owl-features owl-carousel">
                  <?php foreach ($getProductSpecial as $item) : ?>
                    <form method="POST">
                      <div class="item p-5">
                        <div class="thumb p-4">
                          <a href="<?= _WEB_ROOT ?>/details/<?= $item['product_id'] ?>/<?= $item['category_id'] ?>"><img src="<?= _WEB_ROOT . '/' . $item['product_image_path'] . $item['product_image'] ?>" alt=""></a>
                        </div>
                        ...
                        <?php endif ?>
                        <h4 class="d-flex justify-content-center align-items-center mt-2 mb-0 m-0" style="font-size: 15px; line-height: 25px !important;"><?= $item['product_name'] ?></h4>
        ...
        <div class="header-text">
          <img src="https://theme.hstatic.net/200000722513/1001090675/14/headblog_banner.jpg?v=2092" alt="" class="rounded-3">
        </div>
        <div class="most-popular mb-5">
          <div class="heading-section text-center">
